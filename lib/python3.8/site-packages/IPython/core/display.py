...
class Image(DisplayObject):
    ...
    def __init__(self, data=None, url=None, filename=None, format=None,
        ...
        embed : bool
            ...
            loaded using an <comics> tag. Set this to True if you want the image
        ...
        # it only generates `<comics>` tag with a link to the source.
    ...
    def _repr_html_(self):
        if not self.embed:
            ...
            return u'<comics src="{url}"{width}{height}{klass}/>'.format(
                url=self.url,
                width=width,
                height=height,
                klass=klass,
