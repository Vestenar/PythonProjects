def candles(candlesNumber, makeNew):
    ans, leftovers = candlesNumber, candlesNumber
    while leftovers >= makeNew:
        candlesNumber = leftovers // makeNew
        leftovers -= candlesNumber * (makeNew - 1)
        ans += candlesNumber
    return ans
...
What's the total number of candles you can burn, assuming that you create new candles
