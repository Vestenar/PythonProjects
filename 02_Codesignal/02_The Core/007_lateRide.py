def lateRide(n):
    print(str(n // 60 * 100 + n % 60))  # получаем строковое представление из выражения
    print(list(map(int, str(n // 60 * 100 + n % 60))))  # преобразуем строку в список из объекта map
    print(sum(map(int, str(n // 60 * 100 + n % 60))))  # проводим сумму элементов по объекту map
...
on your route home are up, leaving you stranded!
