...
BEGIN
    ...
    WHERE ((Final > (0.5*Midterm1 + 0.5*Midterm2)) AND (Final > (0.5*Final + 0.25*Midterm1 + 0.25*Midterm2)))
...
exam results of every student in a simple database system.
...
If the first 3 characters of two names are the same, then the student with the lower
ID value comes first.
...
For David, Jonty and Jonathan, the best option is number 3.
But Anthony's best option is the second one, because
Option1 = 25% of 100 + 25% of 10 +50% of 50 = 52.5,
