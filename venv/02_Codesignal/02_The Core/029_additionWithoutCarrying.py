def additionWithoutCarrying(param1, param2):
    ...
    param1 = "{0:0{1}d}".format(param1, k)
    param2 = "{0:0{1}d}".format(param2, k)
    return "".join(str((int(param1[i])+int(param2[i])) % 10) for i in range(k))

print(additionWithoutCarrying(999,9999))
...
Note: the boy used this site as the source of knowledge,
feel free to check it out too if you are not familiar with column addition.
