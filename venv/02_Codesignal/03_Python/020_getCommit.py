...
print(getCommit("noAUTHORofTHIScOmMiT"))
print(getCommit("?????!+0"))
'''
The Abanamama Version System (AVS) is a software versioning and revision control 
system used in highly secure environments. In this system, each commit is assigned a unique name, 
