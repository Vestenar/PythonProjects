...
repeatChar = lambda c, nn: c * nn
print(repeatChar(ch, n))

'''
To make debug output more understandable, you often separate sets of logs 
by a single line of the same character. Since you use this method very often, 
